...
foreach($task1 as $x) {
    $result = preg_replace('/([12][0-9]{3})-([0-9]{2})-([0-9]{2})/', '$2/$3/$1', $x);
    var_dump($result);
}
...
$result = preg_replace('/https?:\/\/[a-zA-Z0-9]+\.[a-zA-Z0-9]+/', '<a href="$0">$0</a>', $text);
echo $result . "\n";
...
foreach($emails AS $email) {
    ...
    $email = preg_replace('/([a-zA-Z0-9]+)\+[a-zA-Z0-9]+@gmail\.com/', '$1@gmail.com', $email);
    var_dump($email);
}
